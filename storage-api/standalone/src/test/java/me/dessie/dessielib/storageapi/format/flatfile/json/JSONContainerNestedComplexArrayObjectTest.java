...
public class JSONContainerNestedComplexArrayObjectTest extends ContainerTestCore<JSONContainer> {

    private final NestedComplexArrayObject testingObject;

    public JSONContainerNestedComplexArrayObjectTest() throws URISyntaxException {
        super(ContainerType.JSON, "testjsonnestedcomplexarrayobject.json", "jsonnestedcomplexarrayobjectcorrect.json");
