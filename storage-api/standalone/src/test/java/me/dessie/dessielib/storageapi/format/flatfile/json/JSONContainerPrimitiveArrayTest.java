...
public class JSONContainerPrimitiveArrayTest extends ContainerTestCore<JSONContainer> {

    public JSONContainerPrimitiveArrayTest() throws URISyntaxException {
        super(ContainerType.JSON, "testjsonprimitivearray.json", "jsonprimitivearraycorrect.json");
    }
