...
public class JSONContainerNestedComplexObjectTest extends ContainerTestCore<JSONContainer> {

    public JSONContainerNestedComplexObjectTest() throws URISyntaxException {
        super(ContainerType.JSON, "testjsonnestedcomplexobject.json", "jsonnestedcomplexobjectcorrect.json");
    }
