...
public abstract class RetrieveArrayContainer<H, N> extends ArrayContainer<H> {
     ...
     */
    public RetrieveArrayContainer(IStorageAPI api) {
        super(api);
    }
     ...
     */
    public RetrieveArrayContainer(IStorageAPI api, StorageSettings settings) {
        super(api, settings);
    }
     ...
     * These keys are equivalent to the {@link me.dessie.dessielib.storageapi.decomposition.StorageDecomposer}'s keys.
     *
            ...
            this.getNestedKeys(obj).forEach(key -> {
                ...
                try {
                    if(isNested(fromKey)) {
                        ...
                        recomposedObject.completeObject(key, this.handleRetrieveList((H) fromKey, this.getAPI().getDecomposer(nestedClass) == null ? null : nestedClass));
                    } else {
