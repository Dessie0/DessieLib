...
public class YAMLContainerBasicObjectTest extends ContainerTestSpigot<YAMLContainer> {

    public YAMLContainerBasicObjectTest() throws URISyntaxException {
        super(ContainerType.YAML, "testyamlbasicobject.yml", "yamlbasicobjectcorrect.yml");
    }
