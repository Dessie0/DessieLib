...
public class YAMLContainerPrimitiveTest extends ContainerTestSpigot<YAMLContainer> {
    public YAMLContainerPrimitiveTest() throws URISyntaxException {
        super(ContainerType.YAML, "testyamlprimitive.yml", "yamlprimitivecorrect.yml");
    }
